...
public class ShowCustomer_Adapter extends RecyclerView.Adapter<ShowCustomer_Adapter.ViewHolder> implements Filterable {
    ...
    public ShowCustomer_Adapter(Activity mContext, List<UserModelClass> list) {
 ...
 @NonNull
    @Override
    public ShowCustomer_Adapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View v = LayoutInflater.from(mContext).inflate(R.layout.usersidelists , null);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final ShowCustomer_Adapter.ViewHolder holder, int position) {
