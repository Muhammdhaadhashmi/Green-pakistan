            ...
            NotifcationHire.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                    ...
                    for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                        ...
                        Log.d("the get result " , dataSnapshot1.child("notificationPersonKey").getValue().toString() +"\n" + mAuth.getUid());
                        if(dataSnapshot1.child("notificationPersonKey").getValue().toString().equals(mAuth.getUid())){
                            StackListToIndentifyWithSpecificChat.add(dataSnapshot1.child("loggerKey").getValue().toString());
                            Toast.makeText(ShowCustomerForChat.this, "addedd", Toast.LENGTH_SHORT).show();
                        }
                    }
                }
                @Override
     ...
     CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                 ...
                 if(usersModelClass.getUserType().equals("Customer") && StackListToIndentifyWithSpecificChat.contains(usersModelClass.getUUID())) {
                     UserLaborList.add(usersModelClass);
                 }
                }
             try {

                 Collections.reverse(UserLaborList);
