...
public class ShowItemsToShopKeeper extends AppCompatActivity {
    androidx.appcompat.widget.Toolbar toolbar  ;
    DatabaseReference CheffFirebaseDatabase;
    List<ItemClass> UserLaborList ;
    RecyclerView recyclerView ;
    LinearLayoutManager linearLayoutManager   ;
    ShowItemtoSheffAdapter Adapter ;
    FirebaseAuth mAuth ;
    @Override
...
mAuth = FirebaseAuth.getInstance() ;
     ...
     CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             try {
                 Adapter = new ShowItemtoSheffAdapter(ShowItemsToShopKeeper.this, UserLaborList);

                 Adapter.setLoggerName(mAuth.getUid());
                 recyclerView.setAdapter(Adapter);
                 ...
                 final ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT| ItemTouchHelper.LEFT) {
                     ...
                     public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                         ...
                         new RecyclerViewSwipeDecorator.Builder(ShowItemsToShopKeeper.this , c ,recyclerView , viewHolder ,dX, dY , actionState , isCurrentlyActive )
                                 .addSwipeRightBackgroundColor(ContextCompat.getColor(ShowItemsToShopKeeper.this ,R.color.red))
                                 .addSwipeRightActionIcon(R.drawable.ic_delete_black_24dp).addSwipeLeftBackgroundColor((ContextCompat.getColor(getApplicationContext() , R.color.yello))).addSwipeLeftActionIcon(R.drawable.ic_call_black_24dp)
                                 .addSwipeLeftBackgroundColor(ContextCompat.getColor(ShowItemsToShopKeeper.this , R.color.yello))
                                 .addSwipeLeftActionIcon(R.drawable.ic_delete_black_24dp).create().decorate();
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(ShowItemsToShopKeeper.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ShowItemsToShopKeeper.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(ShowItemsToShopKeeper.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
    }
