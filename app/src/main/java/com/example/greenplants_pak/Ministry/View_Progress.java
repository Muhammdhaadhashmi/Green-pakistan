...
import com.example.greenplants_pak.Adatper.GridAdapterForProgress;
import com.example.greenplants_pak.Customer.ShowItemAdapter;
...
public class View_Progress extends AppCompatActivity {
    ...
    List<Progress> ShowItemList ;
    RecyclerView recyclerView ;
    LinearLayoutManager linearLayoutManager   ;
    GridAdapterForProgress Adapter ;
    @Override
...
//        toolbar.inflateMenu(R.menu.searchmenu);
    ...
    private void init() {
    CheffFirebaseDatabase = FirebaseDatabase.getInstance().getReference("add_progress");
     ...
     CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                 Progress usersModelClass = dataSnapshot1.getValue(Progress.class);
                 ShowItemList.add(usersModelClass);}


             try {

                 Adapter = new GridAdapterForProgress(View_Progress.this, ShowItemList);
...
//                                 .addSwipeLeftActionIcon(R.drawable.ic_message_black_24dp).create().decorate();
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(View_Progress.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(View_Progress.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(View_Progress.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
    }
}
