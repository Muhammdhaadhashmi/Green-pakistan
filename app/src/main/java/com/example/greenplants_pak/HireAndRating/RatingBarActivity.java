package com.example.greenplants_pak.HireAndRating;
...
import com.example.greenplants_pak.Model.RatingLaborModelClass;
...
public class RatingBarActivity extends AppCompatActivity {
    ...
    SubRating  = findViewById(R.id.submitrating);
        ...
        LogName.setText(getIntent().getStringExtra("LoggerName"));
    ...
    SubRating.setOnClickListener(new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            String LoggerName = LogName.getText().toString().trim();
