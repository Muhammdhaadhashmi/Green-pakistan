...
public class ShowShopKeeper extends AppCompatActivity {
  ...
  //                  getSupportActionBar().setBackgroundDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.containerbtnstyle));
     ...
     CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             try {
                 ...
                 Adapter = new ShowShopKeeperAdapter(ShowShopKeeper.this, chefflist);
                 Adapter.set();
                 recyclerView.setAdapter(Adapter);
                 ...
                 final ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT| ItemTouchHelper.LEFT) {
                     ...
                     public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                         ...
                         new RecyclerViewSwipeDecorator.Builder(ShowShopKeeper.this , c ,recyclerView , viewHolder ,dX, dY , actionState , isCurrentlyActive )
                                 .addSwipeRightBackgroundColor(ContextCompat.getColor(ShowShopKeeper.this , R.color.green))
                                 ...
                                 .addSwipeLeftBackgroundColor(ContextCompat.getColor(ShowShopKeeper.this , R.color.yello))
                     ...
                     public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                      ...
                      if(direction == 8) {
                          ...
                          Toast.makeText(ShowShopKeeper.this, "Message Sent", Toast.LENGTH_SHORT).show();
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(ShowShopKeeper.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ShowShopKeeper.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(ShowShopKeeper.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
