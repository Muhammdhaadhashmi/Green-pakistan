...
public class ShowItemAdapterForComplain extends RecyclerView.Adapter<ShowItemAdapterForComplain.ViewHolder> implements Filterable {
    ...
    public ShowItemAdapterForComplain(Activity mContext, List<ItemClass> list) {
 ...
 @NonNull
    @Override
    public ShowItemAdapterForComplain.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
       View v = LayoutInflater.from(mContext).inflate(R.layout.usersidelists , null);
        return new ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(@NonNull final ShowItemAdapterForComplain.ViewHolder holder, int position) {
        ...
        holder.SkillsTextView.setText("Click here to complain ");
        holder.SkillsTextView.setTextColor(Color.RED);
      ...
      holder.imageView.setImageResource(R.drawable.complaints);
        holder.imageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(mContext , Add_complain_.class);
                i.putExtra("pid" , usersModelClass.getItem_ID());
                i.putExtra("Sid" , usersModelClass.getCheff_id());
