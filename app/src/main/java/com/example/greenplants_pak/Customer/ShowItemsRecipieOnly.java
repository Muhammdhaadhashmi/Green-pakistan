...
public class ShowItemsRecipieOnly extends AppCompatActivity {
     ...
     CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             try {
                 ...
                 Adapter = new ShowItemAdapter(ShowItemsRecipieOnly.this, ShowItemList);
...
//                                 .addSwipeLeftActionIcon(R.drawable.ic_message_black_24dp).create().decorate();
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(ShowItemsRecipieOnly.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ShowItemsRecipieOnly.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(ShowItemsRecipieOnly.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
    }
}
