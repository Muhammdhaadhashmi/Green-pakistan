...
public class ShowshopForChat extends AppCompatActivity {
    androidx.appcompat.widget.Toolbar toolbar  ;
    DatabaseReference CheffFirebaseDatabase;
    List<UserModelClass> UserLaborList ;
    List<String> StackListToIndentifyWithSpecificChat ;
  ...
  //                  getSupportActionBar().setBackgroundDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.containerbtnstyle));
    ...
    protected void onStart() {
        ...
        try{
         ...
         DatabaseReference   NotifcationHire = FirebaseDatabase.getInstance().getReference("response" );
            StackListToIndentifyWithSpecificChat = new ArrayList<>( ) ;
            NotifcationHire.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                    StackListToIndentifyWithSpecificChat.clear();
                    for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                        ...
                        if(notification.getLoggerKey().equals(mAuth.getUid())){
                            StackListToIndentifyWithSpecificChat.add(dataSnapshot1.child("notificationPersonKey").getValue().toString());
                        }
                    }
                        ...
                        CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                                    ...
                                    // Toast.makeText(ShowshopForChat.this, ""+StackListToIndentifyWithSpecificChat.get(0)  ,Toast.LENGTH_SHORT).show();
                                    if(usersModelClass.getUserType().equals("ShopKeeper") && StackListToIndentifyWithSpecificChat.contains(usersModelClass.getUUID())){
                                        UserLaborList.add(usersModelClass);
                                    }
                                }
                                try {
                                    Adapter = new ShowCheffAdapterForChat(ShowshopForChat.this, UserLaborList);
                                    Adapter.set();
                                    recyclerView.setAdapter(Adapter);
...
//                                 .addSwipeLeftActionIcon(R.drawable.ic_message_black_24dp).create().decorate();
                                        ...
                                        public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                                            ...
                                            if(direction == 8) {
                                                ...
                                                Toast.makeText(ShowshopForChat.this, "Message Sent", Toast.LENGTH_SHORT).show();
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(ShowshopForChat.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ShowshopForChat.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ...
        ActivityCompat.requestPermissions(ShowshopForChat.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
