...
public class ShowNotitifcationResponse extends AppCompatActivity {
    List<Response> notificationslist;
        ...
        NotifcationHire.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                    Response notification = dataSnapshot1.getValue(Response.class);
                ...
                final ResponseAdapter Adapter = new ResponseAdapter(getApplicationContext(), notificationslist);
                ...
                final ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT) {
                    ...
                    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                        ...
                        Adapter.setIdToDelete( getIntent().getStringExtra("push"));
                        Adapter.ContectCreation( ShowNotitifcationResponse.this);
