...
public class ShowMinistry extends AppCompatActivity {
    androidx.appcompat.widget.Toolbar toolbar  ;
    DatabaseReference CheffFirebaseDatabase;
    List<UserModelClass> chefflist ;
    RecyclerView recyclerView ;
    LinearLayoutManager linearLayoutManager   ;
    ShowShopKeeperAdapter Adapter ;
    @Override
  ...
  //                  getSupportActionBar().setBackgroundDrawable(ContextCompat.getDrawable(getApplicationContext(), R.drawable.containerbtnstyle));
     ...
     CheffFirebaseDatabase.addValueEventListener(new ValueEventListener() {
         ...
         public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
             ...
             for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()){
                 ...
                 if(usersModelClass.getUserType().equals("Ministry")){
                 chefflist.add(usersModelClass);}
             }
             try {
                 Collections.sort(chefflist);
                 Collections.reverse(chefflist);
                 Adapter = new ShowShopKeeperAdapter(ShowMinistry.this, chefflist);
                 Adapter.set();
                 recyclerView.setAdapter(Adapter);
                 final ItemTouchHelper itemTouchHelper = new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.RIGHT| ItemTouchHelper.LEFT) {
                     ...
                     public void onChildDrawOver(@NonNull Canvas c, @NonNull RecyclerView recyclerView, RecyclerView.ViewHolder viewHolder, float dX, float dY, int actionState, boolean isCurrentlyActive) {
                         new RecyclerViewSwipeDecorator.Builder(ShowMinistry.this , c ,recyclerView , viewHolder ,dX, dY , actionState , isCurrentlyActive )
                                 .addSwipeRightBackgroundColor(ContextCompat.getColor(ShowMinistry.this , R.color.green))
                                 ...
                                 .addSwipeLeftBackgroundColor(ContextCompat.getColor(ShowMinistry.this , R.color.yello))
                     ...
                     public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
                      if(direction == 8) {
                          ...
                          Toast.makeText(ShowMinistry.this, "Message Sent", Toast.LENGTH_SHORT).show();
    ...
    private void MessageOnMbile(String getNodeAtPosition) {
        String message = "i Want to complain some one contract my number back" + getNodeAtPosition ;
    ...
    private void CAllByPhone(String getNodeAtPosition) {
        ...
        if(!getNodeAtPosition.isEmpty()){
            ...
            if (ActivityCompat.checkSelfPermission(ShowMinistry.this,
    ...
    private boolean checkPermission() {
        int result = ContextCompat.checkSelfPermission(ShowMinistry.this, Manifest.permission.CALL_PHONE);
    ...
    private void requestPermission() {
        ActivityCompat.requestPermissions(ShowMinistry.this,new String[]{Manifest.permission.CALL_PHONE}, 1);
